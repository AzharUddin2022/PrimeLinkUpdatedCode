...
{
    public class AQLDefectRepository : GenericRepository<AQLDefect>, IAQLDefectRepository
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public AQLDefectRepository(DbContext context)
        {
            Context = context;
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public AQLDefect GetAQLDefectById(int Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public AQLDefect GetAQLDefectByReferenceId(int ReferenceId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<AQLDefect> GetAllAQLDefects()
        {
