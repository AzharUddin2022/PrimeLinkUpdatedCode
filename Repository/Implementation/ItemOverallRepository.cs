...
{
    public class ItemOverallRepository : GenericRepository<ItemOverall>, IItemOverallRepository
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public ItemOverallRepository(DbContext context)
        {
            Context = context;
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemOverall GetItemOverallById(int Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemOverall GetItemOverallByReferenceId(int ReferenceId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ItemOverall> GetAllItemOveralls()
        {
