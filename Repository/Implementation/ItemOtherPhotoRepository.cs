...
{
    public class ItemOtherPhotoRepository : GenericRepository<ItemOtherPhoto>, IItemOtherPhotoRepository
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public ItemOtherPhotoRepository(DbContext context)
        {
            Context = context;
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemOtherPhoto GetItemOtherPhotoById(int Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemOtherPhoto GetItemOtherPhotoByReferenceId(int ReferenceId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ItemOtherPhoto> GetAllItemOtherPhotos()
        {
