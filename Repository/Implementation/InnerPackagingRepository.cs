...
{
    public class InnerPackagingRepository : GenericRepository<InnerPackaging>, IInnerPackagingRepository
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public InnerPackagingRepository(DbContext context)
        {
            Context = context;
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public InnerPackaging GetInnerPackagingById(int Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public InnerPackaging GetInnerPackagingByReferenceId(int ReferenceId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<InnerPackaging> GetAllInnerPackagings()
        {
