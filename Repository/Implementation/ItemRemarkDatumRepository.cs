...
{
    public class ItemRemarkDatumRepository : GenericRepository<ItemRemarkDatum>, IItemRemarkDatumRepository
    {
        #region Constructor
        /// <summary>
        /// Constructor
        ...
        public ItemRemarkDatumRepository(DbContext context)
        {
            Context = context;
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemRemarkDatum GetItemRemarkDatumById(int Id)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ItemRemarkDatum GetItemRemarkDatumByReferenceId(int ReferenceId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ItemRemarkDatum> GetAllItemRemarkDatums()
        {
