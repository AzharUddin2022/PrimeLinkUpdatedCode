...
namespace Service.Common.Implementation
{
    ...
    //public abstract class GenericServices<TEntity> : IDisposable, IGenericServices<TEntity> where TEntity : class
    //{
    //    private IUnitOfWork _unitOfWork;
    ...
    //        }
    //        _genericRepository.Save(entity);
    //        _unitOfWork.Commit();
    //    }
    ...
    //    public virtual TEntity Find(System.Linq.Expressions.Expression<Func<TEntity, bool>> predicate)
    //    {
